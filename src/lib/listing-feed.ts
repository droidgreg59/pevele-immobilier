...
export function feedNodeForListing(l: ListingWithOwner): Record<string, unknown> {
  ...
  return {
    ...
    pieces: l.pieces,
    chambres: l.chambres,
    ...(l.anneeConstruction ? { anneeConstruction: l.anneeConstruction } : {}),
    ...(l.etat ? { etat: l.etat } : {}),
    ...(l.exposition ? { exposition: l.exposition } : {}),
    ...(l.surfaceTerrain ? { surfaceTerrain: l.surfaceTerrain } : {}),
    ...(l.etage != null ? { etage: l.etage } : {}),
    ...(l.ascenseur != null ? { ascenseur: l.ascenseur ? "oui" : "non" } : {}),
    ...(l.nbSallesDeBain ? { sallesDeBain: l.nbSallesDeBain } : {}),
    ...(l.stationnement ? { stationnement: l.stationnement } : {}),
    ...(l.chauffageType ? { chauffageType: l.chauffageType } : {}),
    ...(l.fibre != null ? { fibre: l.fibre ? "oui" : "non" } : {}),
    ...(l.assainissement ? { assainissement: l.assainissement } : {}),
    ...(l.dpe ? { dpe: l.dpe } : {}),
    ...(l.ges ? { ges: l.ges } : {}),
