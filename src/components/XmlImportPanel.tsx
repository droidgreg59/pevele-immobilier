  ...
  return (
    <div className="flex max-w-[640px] flex-col gap-5 rounded-2xl border border-line bg-white p-6">
      <div>
        ...
        <p className="mt-1.5 font-sans text-[13.5px] leading-[1.6] text-muted">
      ...
      <form action={urlAction} className="flex flex-col gap-2">
        <label className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="rounded-xl border border-line bg-white px-4 py-3 font-sans text-[14px] text-ink outline-none transition focus:border-blue focus:ring-2 focus:ring-blue/15"
          />
        </label>
        {urlState.error ? (
        ...
        {urlState.success ? (
          <p className="m-0 rounded-xl bg-[#EAF4EA] px-4 py-3 font-mono text-[12px] text-ink">
            Adresse enregistrée.
          </p>
        ) : null}
        <button
          type="submit"
          disabled={urlPending}
          className="self-start rounded-full border border-line bg-white px-5 py-2.5 font-mono text-[11px] font-medium text-ink transition hover:bg-surface disabled:opacity-60"
        >
      ...
      <div className="border-t border-line pt-5">
        ...
        <form action={syncAction} className="mt-3 flex flex-col gap-2">
          ...
          <button
            ...
            className="self-start rounded-full bg-yellow px-6 py-3 font-mono text-xs font-semibold text-ink shadow-sm transition hover:shadow-md hover:brightness-95 disabled:opacity-60"
          >
