...
export default async function CompteCourtierParametresPage() {
  const session = await getSession();
  if (!session) redirect("/connexion?next=/compte/courtier/parametres");
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="mt-5 flex flex-col gap-1.5 rounded-2xl border border-line bg-white p-6 text-[13px] text-ink shadow-sm">
        ...
        <span>Type de compte — Courtier</span>
      </div>
